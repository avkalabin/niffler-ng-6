...
public class CategoryExtension implements
    ...
    @Override
    public CategoryJson[] resolveParameter(@Nonnull ParameterContext parameterContext, @Nonnull ExtensionContext extensionContext) throws ParameterResolutionException {
